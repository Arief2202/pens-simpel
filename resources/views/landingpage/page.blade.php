...
{{-- js --}}
    ...
    <body id="page-top">
            ...
            <div class="container px-4 px-lg-5 h-100">
                <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center">
                  <div class="col-lg-6 d-flex flex-column justify-content-center">
                    ...
                    <h2 data-aos="fade-up" style="color: white; font-weight: bolder">Semua data penelitian ada dalam satu aplikasi</h2>
                    ...
                    <div data-aos="fade-up" data-aos-delay="600">
                        <div class="col-lg-8 align-self-baseline">
                              <a class="btn btn-primary btn-xl" style="width: 49%; background-color:#FF8A00" href="/login">login dosen</a>
                              <a class="btn btn-primary btn-xl" style="width: 49%; background-color:#FF8A00" href="/login">login p3m</a>
                              <div class="row-lg pt-3 pb-3">
                                <a class="btn btn-primary btn-xl" style="width: 100%; background-color:#FF8A00" href="/register">register super user</a>
                            </div>
                        </div>
                    </div>
                  </div>
                  <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
                    <img src="../img/pens.jpg" class="img-thumbnail" style="background-color: rgb(5, 67, 94); border: none; padding:20px;" alt="">
                  </div>
                </div>
              </div>
        </header>
        <!-- Call to action-->
        <section class="page-section text-white" style="background: linear-gradient(to bottom, rgba(5, 67, 94, 0.83), rgb(5, 67, 94)),url(../img/bg.png)">
                ...
                <div class="row gx-4 gx-lg-5">
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            ...
                            <p class="text-muted mb-0">Website ini menyajikan grafik penelitian yang ada di PENS mulai tahun 2019 hingga saat ini</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            ...
                            <p class="text-muted mb-0">Selain menyajikan data penelitian secara lengkap, website ini juga mempermudah anda dalam mencari dan menyaring data-data yang anda butuhkan</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            ...
                            <p class="text-muted mb-0">Segala macam pengumuman terbaru terkait penelitian yang ada di PENS akan diupdate pada website ini</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            ...
                            <p class="text-muted mb-0">Website ini dapat diakses seutuhnya bagi dosen dan P3M di PENS, sehingga keamanan dan kuliatas data akan terjamin</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8 col-xl-6 text-center">
                        ...
                        <hr class="divider" />
                        <p class="text-muted mb-5">Silahkan berikan masukan berupa kritik dan saran anda terhadap aplikasi kami.</p>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <form id="masukanForm" data-sb-form-api-token="API_TOKEN">
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <div class="invalid-feedback" data-sb-feedback="phone:required">Nomor telepon anda harus diisi</div>
                            </div>
                            <!-- Message input-->
                            <div class="form-floating mb-3">
        ...
        <footer class="bg-light py-5">
            <div class="container px-4 px-lg-5"><div class="small text-center text-muted">Copyright &copy; 2022 - RPL A5</div></div>
        </footer>
        <!-- Bootstrap core JS-->

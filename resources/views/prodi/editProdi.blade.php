  ...
  <div class="col-md-12">
    <div class="card border-2 shadow rounded" style="background-color: rgba(177, 233, 255, 0.155); backdrop-filter: blur(3px);">
        ...
        <div class="card-body" style="background-color: white">
            <form action="/editProdi/{{ $prodi->id }}" method="post">
                @csrf
                <div class="form-group">
                    <label for="Prodi"><strong> Nama Prodi</strong></label>
                    <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror"
                        id="Prodi" placeholder="Masukkan Prodi" value="{{ old('judul',$prodi->nama) }}" required>
                    @error('nama')
                ...
                <div class="d-flex justify-content-end">
                    <button type="submit" class="btn btn-success" style="width: 150px">Ubah</button>
                </div>
            </form>
        </div>
    </div>
